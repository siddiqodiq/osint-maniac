...
MEDIUM = 'M'
HARD = 'H'
sulit = 'category_sulit'
mudah = 'category_mudah'
sedang = 'category_sedang'



difficulty = [(EASY, 'easy'), (MEDIUM, 'medium'), (HARD, 'hard')]
category = [(sulit, 'category_sulit'), (mudah, 'category_mudah'), (sedang, 'category_sedang')]
...
class Questions(models.Model):
    ...
    category = models.CharField(max_length=50, choices=category, default=mudah)
